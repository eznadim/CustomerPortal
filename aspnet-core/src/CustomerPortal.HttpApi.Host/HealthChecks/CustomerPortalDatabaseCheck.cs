...
public class CustomerPortalDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public CustomerPortalDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
